...
\item \small Dependent variable: Urban--Rural Income Ratio. Each row drops one never-treated county.
\item County and year fixed effects. Standard errors clustered by county.
